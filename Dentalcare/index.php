		    ...
		    <div id="myCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-wrap="true">
				...
				<div class="carousel-inner">
					<div class="carousel-item active">
						<img class="bd-Placeholder-img" width="100%" height="auto" loading="lazy" src="<?php echo get_theme_mod('banner_image1', get_bloginfo('template_url').'/img/intro1.png')?>" alt="">
			...
			<div id="about" class="about">
				<div class="container">
					<div class="row gx-5 align-items-center">
						<div class="col-md-5">
							<div class="content-left">
								<img loading="lazy" src="<?php the_field('about_image2') ?>" alt="<?php the_field('about_image2') ?>">
								<div class="open">
