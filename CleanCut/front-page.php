        ...
        <div class="container">
            <div class="col-md-12">
                <div class="showcase-content">
                    ...
                    <a class="btn btn-light btn-lg" href="<?php echo get_theme_mod('facebook_url','http://facebook.com'); ?>" target="_blank"><i class="fa fa-facebook fa-fw"></i> Facebook</a>
                    <?php endif; ?>
                    
                    <?php if(get_theme_mod('twitter_url', 'http://twitter.com') != '') : ?>
                    <a class="btn btn-light btn-lg" href="<?php echo get_theme_mod('twitter_url','http://twitter.com'); ?>" target="_blank"><i class="fa fa-twitter fa-fw"></i> Twitter</a>
                    <?php endif; ?>

                    <?php if(get_theme_mod('linkedin_url', 'http://linkedin.com') != '') : ?>
                    <a class="btn btn-light btn-lg" href="<?php echo get_theme_mod('facebook_url','http://linkedin.com'); ?>" target="_blank"><i class="fa fa-linkedin fa-fw"></i> Linkedin</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
    ...
    <?php if($latest_blog_posts->have_posts()) : while($latest_blog_posts->have_posts()) : $latest_blog_posts->the_post(); ?>
        ...
        <?php
            ...
            if($i % 2 != 0){
                ...
                $img_class = 'rounded-circle img-responsive animated fadeInRight';
            } else {
                // Even Post
                $section_class = 'section-b';
                  $left_class = 'col-lg-5  animated fadeInRight';
                  $right_class = 'col-lg-5 offset-lg-2 col-sm-6';
